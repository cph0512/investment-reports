...
PREV_TW='2026-07-03'
PREV_US='2026-07-02（美國 7/3 獨立紀念日補假休市）/ 最新公告日'
...
upstream='07:45 deep research 為今日台北日期 2026-07-04，DR_STATUS=partial；非 stale/failed。主缺口為 6 月營收尚未達法定公告期限、台股 7/2 個股價量未取得官方結構化資料；本報以 TWSE/TPEx 官方月營收與重大訊息、SEC/公司來源快速補查。'
summary_cards=[
 ('neutral','上游 QC 通過','注入上游為今日台北日期 2026-07-04、DR_STATUS=partial 且非 failed；可作為今日線索，但明列其 partial 缺口。','上游深度研究 / 本報官方補查'),
